...
// SSR-safe dynamic import — LocationPicker uses browser APIs
const LocationPicker = dynamic(
  () => import("@/components/map/LocationPicker"),
  { ssr: false, loading: () => <div className="h-56 bg-gray-100 rounded-lg border border-gray-300 flex items-center justify-center text-sm text-gray-400">Loading map…</div> }
);
...
export default function NewReportPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (isNaN(lat) || isNaN(lng)) {
      setError("Please select a location on the map or enter valid coordinates.");
      return;
    }
      ...
      <div className="max-w-xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-500 mt-1">
            Describe the problem and where it is. We&apos;ll route it to the right city department.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Describe the issue — what you see, any safety concerns, how long it has been there…"
              value={form.description} onChange={handleChange}
              className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
            />
            <p className="text-xs text-gray-400 mt-1">{form.description.length}/2000 (min 10)</p>
          </div>
          ...
          <div>
            ...
            {imagePreview ? (
              <div className="relative">
                <Image src={imagePreview} alt="Preview" width={400} height={200}
              ...
              <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-blue-400 transition-colors">
                <span className="text-gray-400 text-sm">Click to upload a photo (JPEG, PNG, WebP — max 10 MB)</span>
          ...
          <div>
            ...
            <LocationPicker
              ...
              initialLng={!isNaN(parsedLng) ? parsedLng : undefined}
            />
            ...
            <div className="grid grid-cols-2 gap-3 mt-3">
              <div>
                ...
                <input id="latitude" name="latitude" type="number" step="any"
                  required min={-90} max={90} placeholder="e.g. 39.999"
              ...
              <div>
                ...
                <input id="longitude" name="longitude" type="number" step="any"
                  required min={-180} max={180} placeholder="e.g. -83.012"
          ...
          <div>
            ...
            <input id="address" name="address" type="text" placeholder="e.g. 123 Oak Street"
          ...
          <div className="space-y-3 pt-1">
            <p className="text-sm font-medium text-gray-700">Contact info (optional — for status updates)</p>
            <input name="contact_email" type="email" placeholder="Email address"
              value={form.contact_email} onChange={handleChange}
              className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
            <input name="contact_phone" type="tel" placeholder="Phone number"
